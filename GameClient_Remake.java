...
public class GameClient_Remake extends Application implements EventHandler<ActionEvent>
{
   // Attributes
   // Stage
   private Stage stage;
            ...
            if(input instanceof String)
            {
               ...
               switch(command)
               {
                  ...
                  case "START_GAME":
                     ...
                     mainPlayer = new Player(stage, playerNumber, carFileArray[carArrayIndex], mainStartX, mainStartY, mainStartDegree, TRACK_WIDTH, TRACK_HEIGHT);
